  ...
  return (
    <section className="w-full">
      <div className="rounded-2xl border border-sf-border bg-white p-6 shadow-sm">
        <h2 className="text-lg font-semibold mb-4">Du jobber med nå</h2>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between rounded-2xl border border-sf-border px-5 py-4">
            <div>
              ...
              <p className="text-sm text-sf-muted">Intensitet: 6/10</p>
            </div>
          ...
          <div className="flex items-center justify-between rounded-2xl border border-sf-border px-5 py-4">
            <div>
              ...
              <p className="text-sm text-sf-muted">Intensitet: 5/10</p>
            </div>
